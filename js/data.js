...
//  页头部分下拉菜单排行榜的悬停保住状态部分
 //DOM4步
  //1.查找触发事件的元素
var newGames=document.querySelectorAll("ul.newGames>li>div:first-child");
var hotGames=document.querySelectorAll("ul.hotGames>li>div:first-child");
var handTours=document.querySelectorAll("ul.handTours>li>div:first-child");
  //2.绑定事件处理函数
